...
function Tag() {
  console.log(chalk.red(__filename),chalk.yellow(">> New Tag Object"));
...
Tag.prototype.register = function(name, fn, options) {
  console.log(chalk.red(__filename),chalk.yellow(">> Register Tag Object"),chalk.green(name));
...
Tag.prototype.render = function(str, options, callback) {
  console.log(chalk.red(__filename),chalk.yellow(">> Render Tag Object"),chalk.green(str));
