...
function generateConsole(args) {
  console.log(chalk.red(__filename),chalk.yellow(">> GENARATE << Generate console function"));
  ...
  function generateFile(path) {
    console.log(chalk.red(__filename),chalk.yellow(">> GENARATE << generateFile()"));
  ...
  function writeFile(path, force) {
    console.log(chalk.red(__filename),chalk.yellow(">> GENARATE << writeFile()"),chalk.green(path));
    var dest = join(publicDir, path);
  ...
  function firstGenerate() {
    console.log(chalk.red(__filename),chalk.yellow(">> GENARATE << firstGenerate()"));
...
function CacheStream() {
  console.log(chalk.red(__filename),chalk.yellow(">> GENARATE << New Cache Stream"));
  Transform.call(this);
