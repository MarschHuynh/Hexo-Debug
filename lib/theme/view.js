...
function View(path, data) {
  console.log(chalk.red(__filename),chalk.yellow(">> New View Objects"),chalk.green(path));
  this.path = path;
...
View.prototype.render = function(options, callback) {
  console.log(chalk.red(__filename),chalk.yellow(">> Render View Objects"),chalk.green(options));
...
View.prototype.renderSync = function(options) {
  console.log(chalk.red(__filename),chalk.yellow(">> RenderSync View Objects"),chalk.green(options));
  options = options || {};
