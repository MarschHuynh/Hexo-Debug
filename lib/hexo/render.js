...
function Render(ctx) {
  console.log(chalk.red(__filename),chalk.yellow(">> New Render Objects"));
  this.context = ctx;
...
Render.prototype.render = function(data, options, callback) {
  console.log(chalk.red(__filename),chalk.yellow(">> render Objects"));
  ...
  return new Promise(function(resolve, reject) {
    ...
    console.log(chalk.red(__filename),chalk.yellow(">> Call Render Function"),chalk.green(ext));
