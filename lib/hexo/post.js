...
Post.prototype.render = function(source, data, callback) {
  ...
  return new Promise(function(resolve, reject) {
    ...
    return ctx.execFilter('before_post_render', data, {context: ctx}).then(function() { //<< escapse code block
    ...
    return ctx.render.render({ //<<== Post will be render here.
      text: data.content,
      path: source,
      engine: data.engine,
      toString: true,
    ...
    data.content = content; //<< Render content finish here
