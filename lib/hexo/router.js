...
function Router() {
  console.log(chalk.red(__filename),chalk.yellow(">> New Router Objects"));
...
Router.prototype.get = function(path) {
  console.log(chalk.red(__filename),chalk.yellow(">> Get Router Objects"),chalk.green(path));
...
Router.prototype.set = function(path, data) {
  console.log(chalk.red(__filename),chalk.yellow(">> Set Router Objects"),chalk.green(path));
  if (typeof path !== 'string') throw new TypeError('path must be a string!');
...
Router.prototype.remove = function(path) {
  console.log(chalk.red(__filename),chalk.yellow(">> Remove Router Objects"),chalk.green(path));
  if (typeof path !== 'string') throw new TypeError('path must be a string!');
  path = this.format(path);
