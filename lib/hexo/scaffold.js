...
function Scaffold(context) {
  console.log(chalk.red(__filename),chalk.yellow(">> New Scaffold Objects"));
...
Scaffold.prototype.get = function(name, callback) {
  console.log(chalk.red(__filename),chalk.yellow(">> Get Scaffold Objects"),chalk.green(name));  
  var self = this;
...
Scaffold.prototype.set = function(name, content, callback) {
  console.log(chalk.red(__filename),chalk.yellow(">> Set Scaffold Objects"),chalk.green(name));
...
Scaffold.prototype.remove = function(name, callback) {
  console.log(chalk.red(__filename),chalk.yellow(">> Remove Scaffold Objects"),chalk.green(name));
